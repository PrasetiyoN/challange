...
export class Tab1Page {
  ...
  inputCheck() {
    if (
      !this.form.nim || !this.form.nama || !this.form.tempat_lahir ||
  ...
  async sendToWhatsapp() {
    ...
    window.open(`https://api.whatsapp.com/send?phone=628567648625&text=${output}`, '_blank');
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/kucingkagetttt?start=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:prasetiyonugraha08@gmail.com?subject=Data&20Informasi&body=${output}`;
